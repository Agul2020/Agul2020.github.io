...
const CACHE_NAME = "Dodge the Creeps-cache";
const OFFLINE_URL = "Dodge the Creeps.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Dodge the Creeps.html","Dodge the Creeps.js","Dodge the Creeps.wasm","Dodge the Creeps.pck","Dodge the Creeps.offline.html","Dodge the Creeps.icon.png","Dodge the Creeps.apple-touch-icon.png"];
